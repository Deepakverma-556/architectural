            ...
            <div className="max-w-xxl mx-auto px-4 w-full">
                <div className="flex flex-wrap items-center justify-center">
                    ...
                    <div className="w-full lg:w-1/2 px-3 max-lg:pt-6 max-lg:text-center">
                        <div>
                            <h2 className="font-poppins text-dark font-semibold text-xxxxl leading-xxl max-lg:leading-tight max-md:text-4xl">Meet and talk with our best architecture</h2>
                            ...
                            <div className="flex items-center gap-7 max-lg:justify-center">
                                <button className="font-poppins font-semibold text-base leading-6 text-white text-nowrap py-5 px-10 bg-blue shadow-[0px_10px_15px_0px] shadow-[#01739933] max-sm:py-4 max-sm:px-6 transition-all duration-300 hover:shadow-[#23a3eb]">
                                    See all team
                                </button>
