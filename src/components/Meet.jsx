        ...
        <section className="py-16 max-md:py-12 max-sm:py-10">
            <div className="max-w-xxl mx-auto px-4 w-full">
                <div className="flex flex-wrap items-center justify-center">
                    ...
                    <div className="w-full lg:w-1/2 px-3 max-lg:pt-6 max-lg:text-center lg:ps-8">
                        <div>
                            ...
                            <p className="font-poppins font-medium text-lg max-lg:text-base leading-7 text-gray pt-9 max-lg:pt-4 pb-16 max-lg:pb-12 max-md:pb-9">All our teams are professional and competent in
                            ...
                            <div className="flex items-center gap-7 max-lg:justify-center">
                                ...
                                <button className="relative py-5 px-10 overflow-hidden font-semibold text-base leading-6 text-white bg-blue shadow-[0px_10px_15px_0px] shadow-[#01739933] transition-all duration-300 max-sm:py-3 max-sm:px-6 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:m-auto before:h-0 before:w-0 before:duration-300 before:ease-out hover:before:h-full hover:before:w-full hover:before:bg-black hover:shadow-none hover:before:opacity-80">
