        ...
        <div id="license" className='font-poppins'>
            <div className='max-w-xxl mx-auto px-4 pt-[74px] max-lg:pt-12 max-sm:pt-10 pb-16 max-lg:pb-12 max-sm:pb-10 '>
                ...
                <div className='flex flex-wrap flex-row -mx-3 pt-16 max-lg:pt-8 max-sm:pt-8 justify-center'>
                    <div className='w-full md:w-1/2 lg:w-1/4 px-4 max-lg:text-center'>
                        <div className='max-lg:flex max-lg:justify-center'>
                            <div className='w-[94px] h-[94px] bg-light-blue rounded-full flex items-center justify-center '>
                    ...
                    <div className='w-full md:w-1/2 lg:w-1/4 px-4 max-lg:text-center max-md:mt-8'>
                        <div className='max-lg:flex max-lg:justify-center'>
                            <div className='w-[94px] h-[94px] bg-light-blue rounded-full flex items-center justify-center '>
                                <div className='w-[74px] h-[74px] bg-dark-blue rounded-full flex items-center justify-center'>
                    ...
                    <div className='w-full md:w-1/2 lg:w-1/4 px-4 max-lg:text-center max-lg:mt-8'>
                        <div className='max-lg:flex max-lg:justify-center'>
                            <div className='w-[94px] h-[94px] bg-light-blue rounded-full flex items-center justify-center '>
                                <div className='w-[74px] h-[74px] bg-dark-blue rounded-full flex items-center justify-center'>
