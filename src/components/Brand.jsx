                ...
                <div className="flex flex-wrap items-center">
                    <div className="w-1/3 lg:w-1/5 px-3">
                        <div className="flex justify-center">
                            <img src={img1} alt="img1" className="max-w-[163px] w-full" />
                            </div>
                    </div>
                    <div className="w-1/3 lg:w-1/5 px-3">
                        <div className="flex justify-center">
                            <img src={img2} alt="img2" className="max-w-[143px] w-full" />
                            </div>
                    </div>
                    <div className="w-1/3 lg:w-1/5 px-3">
                        <div className="flex justify-center">
                            <img src={img3} alt="img3" className="max-w-[126px] w-full" />
                            </div>
                    </div>
                    <div className="w-1/2 lg:w-1/5 px-3">
                        <div className="flex justify-center">
                            <img src={img4} alt="img4" className="max-w-[146px] w-full" />
                            </div>
                    </div>
                    <div className="w-1/2 lg:w-1/5 px-3">
                        <div className="flex justify-center">
                            <img src={img5} alt="img5" className="max-w-[196px] w-full" />
                            </div>
                    </div>
                </div>
            </div>
