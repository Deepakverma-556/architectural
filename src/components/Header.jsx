      ...
      <div className="max-w-xxl mx-auto px-4">
        <div className="flex flex-wrap justify-between relative max-lg:hidden">
          ...
          <div className="w-full lg:w-8/12 absolute -right-44 max-h-10 h-full">
            <div className="flex items-center gap-10 py-9 px-8 bg-gradient-to-r from-[#399fd8] via-[#0775b4] to-[#003756]">
              ...
              <div className="relative">
                <p className="font-bold text-4xl leading-xl text-white max-w-[117px]">
                  25
        ...
        <div className="flex lg:hidden items-center gap-10 py-9 px-8 bg-gradient-to-r from-[#399fd8] via-[#0775b4] to-[#003756]">
          <p className="font-medium text-base leading-7 text-white">
            General <br /> <br />
            <span className="font-semibold text-2xl leading-9">Project</span>
          </p>
          <div className="relative">
            <p className="font-bold text-4xl leading-xl text-white max-w-[117px]">
              25
              <span className="font-medium text-lg leading-7"> Years </span>
              <span className="font-semibold text-2xl leading-9">Operated</span>
            </p>
            <div className="absolute top-0 right-0">
              <svg
                width="20"
