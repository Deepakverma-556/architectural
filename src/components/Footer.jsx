...
const Footer = () => {
    return (
        <div className='bg-gradient-to-r from-[#474747] to-[#222222] shadow-[0px_10px_15px_0px] shadow-[#9797971F]'>
            <div className='max-w-xxl mx-auto px-4 pb-20 pt-20 max-sm:pb-10 max-sm:pt-10'>
                <div className='flex flex-wrap flex-row -mx-3 justify-between'>
                    <div className='w-full  md:w-6/12 px-3 max-sm:text-center'>
                        <div >
                            <p className='font-poppins text-white font-semibold text-base leading-6'>General Project</p>
                            <p className='font-dm-sans text-white font-normal text-base leading-7 py-8'>is a general contractor company based in Jakarta. More than 25 years of experience in building and carving out Indonesia's development.</p>
                            <div className='flex items-center gap-[6px] max-sm:justify-center'>
                                <a href=""><div className='w-[42px] h-[40px] bg-very-dark-blue rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300'>
                    ...
                    <div className='w-full  md:w-5/12 px-3 max-md:pt-8'>
                        <div className='flex flex-wrap flex-row -mx-3'>
                            <div className='w-full sm:w-5/12 px-3 max-sm:text-center'>
                                <ul className='font-dm-sans text-white'>
                                    <li className='font-bold text-lg pb-7'>Company</li>
                                    <li className='pb-6 '><a href="#" className="font-normal text-base relative group">
                                        About
                            ...
                            <div className='w-full sm:w-5/12 px-3 max-sm:text-center max-sm:pt-5'>
                                <ul className='font-dm-sans text-white'>
                                    <li className='font-bold text-lg pb-7'>More</li>
                                    <li className='pb-6'><a href="#" className="font-normal text-base relative group">
                                        Documentation
                                        <div className="bg-gray h-[1px] absolute bottom-0 left-1/2 right-1/2 group-hover:left-0 group-hover:right-0 origin-center transition-all duration-300"></div>
                                    </a>
