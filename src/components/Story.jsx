                ...
                <div className='flex flex-wrap flex-row -mx-3 '>
                    <div className='w-full lg:w-1/2 px-4 '>
                        <div className='max-lg:text-center'>
                            ...
                            <button className="max-sm:py-3 max-sm:px-8 mt-12 py-5 px-10 max-lg:mt-5 font-semibold text-base leading-6 text-white bg-blue shadow-[0px_10px_15px_0px] [#01739933]">
                                See More
                            </button>
                        </div>
                    </div>
