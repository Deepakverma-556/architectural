...
const Story = () => {
    return (
        <div id="story" className='font-poppins'>
                ...
                <div className='flex flex-wrap flex-row -mx-3 justify-center'>
                    <div className='w-full lg:w-1/2 px-4 '>
                        <div className='max-lg:text-center'>
                            <h2 className='text-dark text-xxxxl font-semibold leading-xxl max-w-[275px] max-lg:mx-auto max-lg:max-w-none max-lg:text-4xl max-sm:text-xxxl'>
